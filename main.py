...
def login_name():
		...
		session['logged_in'] = True
                return "<label>&emsp;Hi " +username+ "</label>" + date_input()
        else:
...
def parameters():
	...
	if request.form.get('WalletID_op') and request.form.get('MDN_op'):
        ...
        elif request.form.get('WalletID_op') and not request.form.get('MDN_op'):
        ...
        elif request.form.get('MDN_op') and not request.form.get('WalletID_op'):
